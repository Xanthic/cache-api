...
@Slf4j
public class CaffeineProviderTest {
	...
	void registeredAsDefaultTest() {
		Assertions.assertEquals(CaffeineProvider.class.getCanonicalName(), CacheApiSettings.getInstance().getDefaultCacheProvider().getClass().getCanonicalName());
	}
