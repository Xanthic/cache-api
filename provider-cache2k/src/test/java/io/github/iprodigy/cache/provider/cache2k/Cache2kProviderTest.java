...
@Slf4j
public class Cache2kProviderTest {
	...
	void registeredAsDefaultTest() {
		Assertions.assertEquals(Cache2kProvider.class.getCanonicalName(), CacheApiSettings.getInstance().getDefaultCacheProvider().getClass().getCanonicalName());
	}
